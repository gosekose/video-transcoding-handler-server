package server.transcode.handler.exception.advice;
...
import server.transcode.handler.exception.exception.*;
...
public class ExceptionControllerAdvice {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorDto> handlerUserNotFoundHandler(NotFoundVideoDescriptionException e) {
